...
void main() {
  group('Web Drag-and-Drop Configuration', () {
    testWidgets('MaterialApp has scrollBehavior configured for web support', 
      ...
      expect(materialApp.scrollBehavior, isNotNull,
        reason: 'scrollBehavior must be set for web drag-and-drop to work with mouse');
    });
    ...
    testWidgets('App builds successfully with scroll configuration', 
      ...
      expect(find.text('Meal Planner'), findsOneWidget,
        reason: 'App should build successfully with scrollBehavior configuration');
      
      // Verify scroll views are present (main vertical + horizontal carousels)
      expect(find.byType(CustomScrollView), findsWidgets,
        reason: 'CustomScrollView widgets should be configured with mouse drag support');
    });
  });
}
